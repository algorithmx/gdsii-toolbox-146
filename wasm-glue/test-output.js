...
function findWasmBinary() {
    return locateFile('test-output.wasm');
}
...
var _gds_parse_from_memory = Module['_gds_parse_from_memory'] = makeInvalidEarlyAccess('_gds_parse_from_memory');
...
function assignWasmExports(wasmExports) {
  ...
  _gds_parse_from_memory = Module['_gds_parse_from_memory'] = createExportWrapper('gds_parse_from_memory', 3);
