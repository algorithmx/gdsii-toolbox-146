...
%
% This helper script analyzes and displays the structure of a VIA test
% generated by test_via_functionality.m
%
...
function view_via_structure(N)
    ...
    % Load GDS file
    gds_file = fullfile(script_dir, 'test_output', sprintf('via_N%d', N), ...
                        sprintf('via_functionality_N%d.gds', N));

    if ~exist(gds_file, 'file')
        fprintf('Error: GDS file not found: %s\n', gds_file);
        fprintf('Run test_via_functionality(%d) first.\n', N);
        return;
    end
